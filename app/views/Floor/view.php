                ...
                <?php if ($floor->floor > 20 && $floor->floor < 26):  ?>
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 3545.15 1235">
                        ...
                        <a href="/ka/apartment/<?= $items[15]['id'] ?>">
                            <polygon id="<?= $items[15]['kvmeter'] ?>&nbsp;㎡<?php if ($items[15]['status'] == 1): ?>&nbsp;Продано<?php endif; ?>" class="<?php if ($items[15]['status'] == 1): ?>sold-polygon<?php else: ?>enabled<?php endif; ?>" points="2062.58 25.5 2062.58 91.5 2134.58 91.5 2134.58 520.5 1816.58 520.5 1816.58 25.5 2062.58 25.5"/>
                        </a>
                        <a href="/ka/apartment/<?= $items[16]['id'] ?>">
                            <polygon id="<?= $items[16]['kvmeter'] ?>&nbsp;㎡<?php if ($items[16]['status'] == 1): ?>&nbsp;Продано<?php endif; ?>" class="<?php if ($items[16]['status'] == 1): ?>sold-polygon<?php else: ?>enabled<?php endif; ?>" points="1816.58 13.5 1816.58 520.5 1507.58 520.5 1507.58 175.5 1324.58 175.5 1324.58 13.5 1816.58 13.5"/>
                        </a>
                        <a href="/ka/apartment/<?= $items[17]['id'] ?>">
                            <polygon id="<?= $items[17]['kvmeter'] ?>&nbsp;㎡<?php if ($items[17]['status'] == 1): ?>&nbsp;Продано<?php endif; ?>" class="<?php if ($items[17]['status'] == 1): ?>sold-polygon<?php else: ?>enabled<?php endif; ?>" points="1324.58 13.5 1324.58 175.5 1117.58 175.5 1102.58 520.5 772.58 520.5 799.58 13.5 1324.58 13.5"/>
                        </a>
                        <a href="/ka/apartment/<?= $items[18]['id'] ?>">
                            <polygon id="<?= $items[18]['kvmeter'] ?>&nbsp;㎡<?php if ($items[18]['status'] == 1): ?>&nbsp;Продано<?php endif; ?>" class="<?php if ($items[18]['status'] == 1): ?>sold-polygon<?php else: ?>enabled<?php endif; ?>" points="220.58 85.5 247.58 235.5 157.58 262.5 187.58 436.5 412.58 520.5 772.58 520.5 799.58 13.5 589.58 13.5 586.58 82.5 220.58 85.5"/>
                        </a>
                    </svg>
                <?php else: ?>
