...
<div class="GE">
                ...
                <div class="container">
                    ...
                    <div class="cta smooth-scroll" style="margin-top: 130px;">
                        <div class="social-btns">
                            ...
                            <a class="btn_ google tooltip" id="stream-button" href='https://www.ipcamlive.com/player/player.php?alias=5edfd00ed0cba&autoplay=1&token=<?php echo $token1; ?> style="margin-top: 15px;" title="ხედი ჩვენი კომპლექსიდან">
    ...
    <section id="section4" class="video-play fixed-bg">
        <div class="color-overlay">
            ...
            <!-- HEADING -->
            <h3 class="white-text wow fadeInLeft MTMedium" data-wow-offset="30" data-wow-duration="1.5s" data-wow-delay="0.15s">ხედი ჩვენი კომპლექსიდან</h3>
