...
class EnController extends AppController {
    public function indexAction() {
        ...
        $this->setMeta(
            'Black Sea Towers – Construction company',
            'utf-8',
            'Black Sea Towers - REAL PALACE is the largest construction company in Georgia. It was founded in 1989 and shortly moved to the leading position in the construction sector of the country, currently maintaining this position with dignity. ',
